...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：斜坡调查表
    /// </summary>
    public class TBL_SLOPEService : RepositoryFactory<TBL_SLOPEEntity>, TBL_SLOPEIService, IAudit
    {
        ...
        private TBL_SLOPE_HISTORYIService history = new TBL_SLOPE_HISTORYService();
        ...
        public IEnumerable<TBL_SLOPEEntity> GetPageList(Pagination pagination, string queryJson)
        {
               var expression = LinqExtensions.True<TBL_SLOPEEntity>();
        ...
        public IEnumerable<TBL_SLOPEEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public TBL_SLOPEEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_SLOPEEntity entity, NEWTBL_SLOPEEntity newentity = null)
        {
             //拆分地理位置（用于基础表赋值）

            string disasterType = "斜坡";
            ...
            if (string.IsNullOrEmpty(auditor))
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_SLOPEEntity, TBL_HAZARDBASICINFOEntity>(entity, hazardInfo);
                    ...
                    //新增历史表
                    TBL_SLOPE_HISTORYEntity historyInfo = EntityCoverter.Covert<TBL_SLOPEEntity, TBL_SLOPE_HISTORYEntity>(entity);
                ...
                {
                    //新增基本信息表
                    TBL_HAZARDBASICINFOEntity hazardInfo = EntityCoverter.Covert<TBL_SLOPEEntity, TBL_HAZARDBASICINFOEntity>(entity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = entity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    auditEntity.BASICINFO = "TBL_SLOPE_HISTORY," + historyInfo.DISASTERUNITNAME + "," + historyInfo.UNIFIEDCODE + "," + disasterType;
        ...
        {
            //查询数据 
            TBL_SLOPE_HISTORYEntity historyEntity = history.GetEntity(bussnessId);

            TBL_HAZARDBASICINFOEntity hazardInfo = null;

            TBL_SLOPEEntity entity = null;
            ...
            switch (updateType)
            {
                ...
                case "A":
                    //新增基本信息表
                    hazardInfo = EntityCoverter.Covert<TBL_SLOPE_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    ...
                    //新增详情表
                    entity = EntityCoverter.Covert<TBL_SLOPE_HISTORYEntity, TBL_SLOPEEntity>(historyEntity);
                    this.BaseRepository().Insert(entity);
                ...
                case "U":
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_SLOPE_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity, hazardInfo);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = historyEntity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
                ...
                case "D":
                    ...
                    string sql = string.Format("update TBL_SLOPE_HISTORY set verification = '{0}' where GUID = '{1}'", historyEntity.VERIFICATION, bussnessId);
        ...
        {
            //详情表
            TBL_SLOPEEntity entity = this.BaseRepository().FindEntity(bussnessKey);
            ...
            {
                //新增历史表
                TBL_SLOPE_HISTORYEntity historyEntity = EntityCoverter.Covert<TBL_SLOPEEntity, TBL_SLOPE_HISTORYEntity>(entity);
                ...
                auditEntity.BUSSNESSTYPE = "A";
                auditEntity.BASICINFO = "TBL_SLOPE_HISTORY," + historyEntity.DISASTERUNITNAME + "," + historyEntity.UNIFIEDCODE + "," + disasterType;
