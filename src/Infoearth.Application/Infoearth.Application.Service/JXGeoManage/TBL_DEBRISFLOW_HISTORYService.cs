...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：泥石流调查表历史表
    /// </summary>
    public class TBL_DEBRISFLOW_HISTORYService : RepositoryFactory<TBL_DEBRISFLOW_HISTORYEntity>, TBL_DEBRISFLOW_HISTORYIService
    {
        ...
        {
            var expression = LinqExtensions.True<TBL_DEBRISFLOW_HISTORYEntity>();
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回列表</returns>
        public IEnumerable<TBL_DEBRISFLOW_HISTORYEntity> GetWhereSubsetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_DEBRISFLOW_HISTORYEntity>();
            ...
            if (!string.IsNullOrEmpty(queryJson) && queryJson != "{}")
            {
                ...
                var expression1 = LinqExtensions.False<TBL_DEBRISFLOW_HISTORYEntity>();
                //镇
