...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：崩塌调查表历史表
    /// </summary>
    public class TBL_AVALANCHE_HIDDEN_HISTORYService : RepositoryFactory<TBL_AVALANCHE_HIDDEN_HISTORYEntity>, TBL_AVALANCHE_HIDDEN_HISTOYRIService
    {
        ...
        {
            var expression = LinqExtensions.True<TBL_AVALANCHE_HIDDEN_HISTORYEntity>();
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回列表</returns>
        public IEnumerable<TBL_AVALANCHE_HIDDEN_HISTORYEntity> GetWhereSubsetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_AVALANCHE_HIDDEN_HISTORYEntity>();
            ...
            if (!string.IsNullOrEmpty(queryJson) && queryJson != "{}")
            {
                ...
                var expression1 = LinqExtensions.False<TBL_AVALANCHE_HIDDEN_HISTORYEntity>();
                //镇
