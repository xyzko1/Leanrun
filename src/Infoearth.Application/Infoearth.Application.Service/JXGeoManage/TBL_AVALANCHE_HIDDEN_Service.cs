...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 创 建：超级管理员
    /// 日 期：2018-03-13 11:25
    /// 描 述：崩塌调查表
    /// </summary>
    public class TBL_AVALANCHE_HIDDENService : RepositoryFactory<TBL_AVALANCHE_HIDDENEntity>, TBL_AVALANCHE_HIDDENIService, IAudit
    {
        ...
        private TBL_AVALANCHE_HIDDEN_HISTOYRIService history = new TBL_AVALANCHE_HIDDEN_HISTORYService();
        ...
        public IEnumerable<TBL_AVALANCHE_HIDDENEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TBL_AVALANCHE_HIDDENEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public TBL_AVALANCHE_HIDDENEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_AVALANCHE_HIDDENEntity entity, NEWTBL_AVALANCHE_HIDDENEntity newentity = null)
        {
            //拆分地理位置（用于基础表赋值）

            string disasterType = "崩塌隐患点";
            ...
            if (string.IsNullOrEmpty(auditor))
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_AVALANCHE_HIDDENEntity, TBL_HAZARDBASICINFOEntity>(entity, hazardInfo);
                    ...
                    //新增历史表
                    TBL_AVALANCHE_HIDDEN_HISTORYEntity historyInfo = EntityCoverter.Covert<TBL_AVALANCHE_HIDDENEntity, TBL_AVALANCHE_HIDDEN_HISTORYEntity>(entity);
                ...
                {
                    //新增基本信息表
                    TBL_HAZARDBASICINFOEntity hazardInfo = EntityCoverter.Covert<TBL_AVALANCHE_HIDDENEntity, TBL_HAZARDBASICINFOEntity>(entity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = entity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    auditEntity.BASICINFO = "TBL_AVALANCHE_HIDDEN_HISTORY," + historyInfo.DISASTERUNITNAME + "," + historyInfo.UNIFIEDCODE + "," + disasterType;
        ...
        {
            //查询数据 
            TBL_AVALANCHE_HIDDEN_HISTORYEntity historyEntity = history.GetEntity(bussnessId);

            TBL_HAZARDBASICINFOEntity hazardInfo = null;

            TBL_AVALANCHE_HIDDENEntity entity = null;
            ...
            switch (updateType)
            {
                ...
                case "A":
                    //新增基本信息表
                    hazardInfo = EntityCoverter.Covert<TBL_AVALANCHE_HIDDEN_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    ...
                    //新增详情表
                    entity = EntityCoverter.Covert<TBL_AVALANCHE_HIDDEN_HISTORYEntity, TBL_AVALANCHE_HIDDENEntity>(historyEntity);
                    this.BaseRepository().Insert(entity);
                ...
                case "U":
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_AVALANCHE_HIDDEN_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity, hazardInfo);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = historyEntity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
                ...
                case "D":
                    ...
                    //将所有该条灾害点的历史数据核销状态修改
                    string sql = string.Format("update TBL_AVALANCHE_HIDDEN_HISTORY set verification = '{0}' where GUID = '{1}'", historyEntity.VERIFICATION, bussnessId);
        ...
        {
            //详情表
            TBL_AVALANCHE_HIDDENEntity entity = this.BaseRepository().FindEntity(bussnessKey);
            ...
            {
                //新增历史表
                TBL_AVALANCHE_HIDDEN_HISTORYEntity historyEntity = EntityCoverter.Covert<TBL_AVALANCHE_HIDDENEntity, TBL_AVALANCHE_HIDDEN_HISTORYEntity>(entity);
                ...
                auditEntity.BASICINFO = "TBL_AVALANCHE_HIDDEN_HISTORY," + historyEntity.DISASTERUNITNAME + "," + historyEntity.UNIFIEDCODE + "," + disasterType;
