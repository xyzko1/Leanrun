...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：地面塌陷调查表历史表
    /// </summary>
    public class TBL_COLLAPSE_HISTORYService : RepositoryFactory<TBL_COLLAPSE_HISTORYEntity>, TBL_COLLAPSE_HISTORYIService
    {
        ...
        {
            var expression = LinqExtensions.True<TBL_COLLAPSE_HISTORYEntity>();
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回列表</returns>
        public IEnumerable<TBL_COLLAPSE_HISTORYEntity> GetWhereSubsetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_COLLAPSE_HISTORYEntity>();
            ...
            if (!string.IsNullOrEmpty(queryJson) && queryJson != "{}")
            {
                ...
                var expression1 = LinqExtensions.False<TBL_COLLAPSE_HISTORYEntity>();
                //镇
