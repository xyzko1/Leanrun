...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：斜坡调查表历史表
    /// </summary>
    public class TBL_SLOPE_HISTORYService : RepositoryFactory<TBL_SLOPE_HISTORYEntity>, TBL_SLOPE_HISTORYIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<TBL_SLOPE_HISTORYEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TBL_SLOPE_HISTORYEntity> GetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_SLOPE_HISTORYEntity>();
        ...
        /// <returns></returns>
        public TBL_SLOPE_HISTORYEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        public TBL_SLOPE_HISTORYEntity GetAuditEntity(string keyValue)
        {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回列表</returns>
        public IEnumerable<TBL_SLOPE_HISTORYEntity> GetWhereSubsetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_SLOPE_HISTORYEntity>();
            ...
            if (!string.IsNullOrEmpty(queryJson) && queryJson != "{}")
            {
                ...
                var expression1 = LinqExtensions.False<TBL_SLOPE_HISTORYEntity>();
                //镇
        ...
        /// <returns></returns>
        public string SaveForm(string keyValue, TBL_SLOPE_HISTORYEntity entity)
        {
