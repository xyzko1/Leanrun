...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：人文经济企业信息表
    /// </summary>
    public class TBL_RWJJ_ENTERPRISEService : RepositoryFactory<TBL_RWJJ_ENTERPRISEEntity>, TBL_RWJJ_ENTERPRISEIService
    {
        ...
        public IEnumerable<TBL_RWJJ_ENTERPRISEEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<TBL_RWJJ_ENTERPRISEEntity>();
        ...
        /// <returns></returns>
        System.Linq.Expressions.Expression<Func<TBL_RWJJ_ENTERPRISEEntity, bool>> queryJsonExpression(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_RWJJ_ENTERPRISEEntity>();
            ...
            #region 根据省市县编号查询
            var expression1 = LinqExtensions.False<TBL_RWJJ_ENTERPRISEEntity>();
            //镇
        ...
        public IEnumerable<TBL_RWJJ_ENTERPRISEEntity> GetList(string queryJson)
        {
             var expression = LinqExtensions.True<TBL_RWJJ_ENTERPRISEEntity>();
        ...
        /// <returns></returns>
        public TBL_RWJJ_ENTERPRISEEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_RWJJ_ENTERPRISEEntity entity)
        {
