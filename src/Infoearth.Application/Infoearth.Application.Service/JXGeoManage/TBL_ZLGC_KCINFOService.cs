...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：治理工程-野外勘察
    /// </summary>
    public class TBL_ZLGC_KCINFOService : RepositoryFactory<TBL_ZLGC_KCINFOEntity>, TBL_ZLGC_KCINFOIService
    {
        ...
        {
            var expression = LinqExtensions.True<TBL_ZLGC_KCINFOEntity>();
        ...
        /// <returns></returns>
        public IEnumerable<TBL_ZLGC_KCINFOEntity> GetListByZlgcID(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_ZLGC_KCINFOEntity>();
        ...
        /// <returns></returns>
        System.Linq.Expressions.Expression<Func<TBL_ZLGC_KCINFOEntity, bool>> queryJsonExpression(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_ZLGC_KCINFOEntity>();
