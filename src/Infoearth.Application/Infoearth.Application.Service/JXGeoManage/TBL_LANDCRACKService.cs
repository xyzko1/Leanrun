...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：地裂缝调查表
    /// </summary>
    public class TBL_LANDCRACKService : RepositoryFactory<TBL_LANDCRACKEntity>, TBL_LANDCRACKIService, IAudit
    {
        ...
        private TBL_LANDCRACK_HISTORYIService history = new TBL_LANDCRACK_HISTORYService();
        ...
        public IEnumerable<TBL_LANDCRACKEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TBL_LANDCRACKEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public TBL_LANDCRACKEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_LANDCRACKEntity entity, NEWTBL_LANDCRACKEntity newentity = null)
        {
             //拆分地理位置（用于基础表赋值）

            string disasterType = "地裂缝";
            ...
            if (string.IsNullOrEmpty(auditor))
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDCRACKEntity, TBL_HAZARDBASICINFOEntity>(entity, hazardInfo);
                    ...
                    //新增历史表
                    TBL_LANDCRACK_HISTORYEntity historyInfo = EntityCoverter.Covert<TBL_LANDCRACKEntity, TBL_LANDCRACK_HISTORYEntity>(entity);
                ...
                {
                    //新增基本信息表
                    TBL_HAZARDBASICINFOEntity hazardInfo = EntityCoverter.Covert<TBL_LANDCRACKEntity, TBL_HAZARDBASICINFOEntity>(entity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = entity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    auditEntity.BASICINFO = "TBL_LANDCRACK_HISTORY," + historyInfo.DISASTERUNITNAME + "," + historyInfo.UNIFIEDCODE + "," + disasterType;
        ...
        {
            //查询数据 
            TBL_LANDCRACK_HISTORYEntity historyEntity = history.GetEntity(bussnessId);

            TBL_HAZARDBASICINFOEntity hazardInfo = null;

            TBL_LANDCRACKEntity entity = null;
            ...
            switch (updateType)
            {
                ...
                case "A":
                    //新增基本信息表
                    hazardInfo = EntityCoverter.Covert<TBL_LANDCRACK_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    ...
                    //新增详情表
                    entity = EntityCoverter.Covert<TBL_LANDCRACK_HISTORYEntity, TBL_LANDCRACKEntity>(historyEntity);
                    this.BaseRepository().Insert(entity);
                ...
                case "U":
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDCRACK_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity, hazardInfo);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = historyEntity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
                ...
                case "D":
                    ...
                    string sql = string.Format("update TBL_LANDCRACK_HISTORY set verification = '{0}' where GUID = '{1}'", historyEntity.VERIFICATION, bussnessId);
        ...
        {
            //详情表
            TBL_LANDCRACKEntity entity = this.BaseRepository().FindEntity(bussnessKey);
            ...
            {
                //新增历史表
                TBL_LANDCRACK_HISTORYEntity historyEntity = EntityCoverter.Covert<TBL_LANDCRACKEntity, TBL_LANDCRACK_HISTORYEntity>(entity);
                ...
                auditEntity.BUSSNESSTYPE = "A";
                auditEntity.BASICINFO = "TBL_LANDCRACK_HISTORY," + historyEntity.DISASTERUNITNAME + "," + historyEntity.UNIFIEDCODE + "," + disasterType;
