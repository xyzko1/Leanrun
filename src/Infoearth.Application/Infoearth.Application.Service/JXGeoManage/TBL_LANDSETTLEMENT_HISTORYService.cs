...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：地面沉降调查表历史表
    /// </summary>
    public class TBL_LANDSETTLEMENT_HISTORYService : RepositoryFactory<TBL_LANDSETTLEMENT_HISTORYEntity>, TBL_LANDSETTLEMENT_HISTORYIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            var expression = LinqExtensions.True<TBL_LANDSETTLEMENT_HISTORYEntity>();
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回列表</returns>
        public IEnumerable<TBL_LANDSETTLEMENT_HISTORYEntity> GetWhereSubsetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_LANDSETTLEMENT_HISTORYEntity>();
            ...
            if (!string.IsNullOrEmpty(queryJson) && queryJson != "{}")
            {
                ...
                var expression1 = LinqExtensions.False<TBL_LANDSETTLEMENT_HISTORYEntity>();
                //镇
        ...
        /// <returns></returns>
        public string SaveForm(string keyValue, TBL_LANDSETTLEMENT_HISTORYEntity entity)
        {
        ...
        /// <returns></returns>
        public TBL_LANDSETTLEMENT_HISTORYEntity GetLatestEntity(string unifycode)
        {
            var expression = LinqExtensions.True<TBL_LANDSETTLEMENT_HISTORYEntity>();
            expression = expression.And(t => t.AUDITSTATUS == "1");
        ...
        public void InsertEntity(TBL_LANDSETTLEMENT_HISTORYEntity entity)
        {
            this.BaseRepository().Insert(entity);
        }
        #endregion
