...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：滑坡调查表
    /// </summary>
    public class TBL_LANDSLIPService : RepositoryFactory<TBL_LANDSLIPEntity>, TBL_LANDSLIPIService, IAudit
    {
        ...
        private TBL_LANDSLIP_HISTORYIService history = new TBL_LANDSLIP_HISTORYService();
        ...
        public IEnumerable<TBL_LANDSLIPEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TBL_LANDSLIPEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public TBL_LANDSLIPEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_LANDSLIPEntity entity, NEWTBL_LANDSLIPEntity newentity=null)
        {
           //拆分地理位置（用于基础表赋值）

            string disasterType = "滑坡";
            ...
            if (string.IsNullOrEmpty(auditor))
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDSLIPEntity, TBL_HAZARDBASICINFOEntity>(entity, hazardInfo);
                    ...
                    hazardInfo.ISZDYHD = entity.ISZDYHD;
                    ...
                    //新增历史表
                    TBL_LANDSLIP_HISTORYEntity historyInfo = EntityCoverter.Covert<TBL_LANDSLIPEntity, TBL_LANDSLIP_HISTORYEntity>(entity);
                    ...
                    historyInfo.THREATENPEOPLE = entity.THREATENPEOPLE;//威胁人口
                    historyInfo.THREATENASSETS = entity.THREATENASSETS;//威胁财产
                ...
                {
                    //新增基本信息表
                    TBL_HAZARDBASICINFOEntity hazardInfo = EntityCoverter.Covert<TBL_LANDSLIPEntity, TBL_HAZARDBASICINFOEntity>(entity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = entity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
            ...
            else
            {
                ...
                {                    
                    ...
                    historyInfo.AUDITOR = auditor;
                    historyInfo.GUID= history.SaveEntity(string.Empty, historyInfo);
                    ...
                    auditEntity.BASICINFO = "TBL_LANDSLIP_HISTORY," + historyInfo.DISASTERUNITNAME + "," + historyInfo.UNIFIEDCODE + "," + disasterType;
        ...
        {
            //查询数据 
            TBL_LANDSLIP_HISTORYEntity historyEntity = history.GetEntity(bussnessId);

            TBL_HAZARDBASICINFOEntity hazardInfo = null;

            TBL_LANDSLIPEntity entity = null;
            ...
            switch (updateType)
            {
                ...
                case "A":
                    //新增基本信息表
                    hazardInfo = EntityCoverter.Covert<TBL_LANDSLIP_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    ...
                    //新增详情表
                    entity = EntityCoverter.Covert<TBL_LANDSLIP_HISTORYEntity, TBL_LANDSLIPEntity>(historyEntity);
                    this.BaseRepository().Insert(entity);
                ...
                case "U":
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDSLIP_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity, hazardInfo);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = historyEntity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
                ...
                case "D":                  
                    ...
                    string sql = string.Format("update TBL_LANDSLIP_HISTORY set verification = '{0}' where GUID = '{1}'", historyEntity.VERIFICATION, bussnessId);
        ...
        {
            //详情表
            TBL_LANDSLIPEntity entity = this.BaseRepository().FindEntity(bussnessKey);
            ...
            {
                //新增历史表
                TBL_LANDSLIP_HISTORYEntity historyEntity = EntityCoverter.Covert<TBL_LANDSLIPEntity, TBL_LANDSLIP_HISTORYEntity>(entity);
                ...
                auditEntity.BUSSNESSTYPE = "A";
                auditEntity.BASICINFO = "TBL_LANDSLIP_HISTORY," + historyEntity.DISASTERUNITNAME + "," + historyEntity.UNIFIEDCODE + "," + disasterType;
