...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：人文经济居民住宅信息表
    /// </summary>
    public class TBL_RWJJ_RESIDENTIALAREAService : RepositoryFactory<TBL_RWJJ_RESIDENTIALAREAEntity>, TBL_RWJJ_RESIDENTIALAREAIService
    {
        ...
        public IEnumerable<TBL_RWJJ_RESIDENTIALAREAEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<TBL_RWJJ_RESIDENTIALAREAEntity>();
        ...
        /// <returns></returns>
        System.Linq.Expressions.Expression<Func<TBL_RWJJ_RESIDENTIALAREAEntity, bool>> queryJsonExpression(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_RWJJ_RESIDENTIALAREAEntity>();
            ...
            #region 根据省市县编号查询
            var expression1 = LinqExtensions.False<TBL_RWJJ_RESIDENTIALAREAEntity>();
            //镇
        ...
        public IEnumerable<TBL_RWJJ_RESIDENTIALAREAEntity> GetList(string queryJson)
        {
             var expression = LinqExtensions.True<TBL_RWJJ_RESIDENTIALAREAEntity>();
        ...
        /// <returns></returns>
        public TBL_RWJJ_RESIDENTIALAREAEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_RWJJ_RESIDENTIALAREAEntity entity)
        {
