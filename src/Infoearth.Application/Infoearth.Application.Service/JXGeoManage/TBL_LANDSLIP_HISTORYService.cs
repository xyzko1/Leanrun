...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：滑坡调查表历史表
    /// </summary>
    public class TBL_LANDSLIP_HISTORYService : RepositoryFactory<TBL_LANDSLIP_HISTORYEntity>, TBL_LANDSLIP_HISTORYIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<TBL_LANDSLIP_HISTORYEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TBL_LANDSLIP_HISTORYEntity> GetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_LANDSLIP_HISTORYEntity>();
        ...
        /// <returns></returns>
        public TBL_LANDSLIP_HISTORYEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        public TBL_LANDSLIP_HISTORYEntity GetAuditEntity(string keyValue)
        {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回列表</returns>
        public IEnumerable<TBL_LANDSLIP_HISTORYEntity> GetWhereSubsetList(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_LANDSLIP_HISTORYEntity>();
            ...
            if (!string.IsNullOrEmpty(queryJson) && queryJson != "{}")
            {
                ...
                var expression1 = LinqExtensions.False<TBL_LANDSLIP_HISTORYEntity>();
                //镇
        ...
        /// <returns></returns>
        public string SaveEntity(string keyValue, TBL_LANDSLIP_HISTORYEntity entity)
        {
        ...
        /// <returns></returns>
        public TBL_LANDSLIP_HISTORYEntity GetLatestEntity(string unifycode)
        {
            var expression = LinqExtensions.True<TBL_LANDSLIP_HISTORYEntity>();
            expression = expression.And(t => t.AUDITSTATUS == "1" || t.AUDITSTATUS == "5");
        ...
        public void InsertEntity(TBL_LANDSLIP_HISTORYEntity entity)
        {
            this.BaseRepository().Insert(entity);
        }
    }
