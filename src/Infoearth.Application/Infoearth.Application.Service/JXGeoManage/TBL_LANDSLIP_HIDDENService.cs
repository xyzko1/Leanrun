...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：滑坡调查表
    /// </summary>
    public class TBL_LANDSLIP_HIDDENService : RepositoryFactory<TBL_LANDSLIP_HIDDENEntity>, TBL_LANDSLIP_HIDDENIService, IAudit
    {
        ...
        private TBL_LANDSLIP_HIDDEN_HISTORYIService history = new TBL_LANDSLIP_HIDDEN_HISTORYService();
        ...
        public IEnumerable<TBL_LANDSLIP_HIDDENEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TBL_LANDSLIP_HIDDENEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public TBL_LANDSLIP_HIDDENEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_LANDSLIP_HIDDENEntity entity, NEWTBL_LANDSLIP_HIDDENEntity newentity=null)
        {
           //拆分地理位置（用于基础表赋值）

            string disasterType = "滑坡隐患点";
            ...
            if (string.IsNullOrEmpty(auditor))
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDSLIP_HIDDENEntity, TBL_HAZARDBASICINFOEntity>(entity, hazardInfo);
                    ...
                    //新增历史表
                    TBL_LANDSLIP_HIDDEN_HISTORYEntity historyInfo = EntityCoverter.Covert<TBL_LANDSLIP_HIDDENEntity, TBL_LANDSLIP_HIDDEN_HISTORYEntity>(entity);
                ...
                {
                    //新增基本信息表
                    TBL_HAZARDBASICINFOEntity hazardInfo = EntityCoverter.Covert<TBL_LANDSLIP_HIDDENEntity, TBL_HAZARDBASICINFOEntity>(entity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = entity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
            ...
            else
            {
                ...
                {                    
                    ...
                    auditEntity.BASICINFO = "TBL_LANDSLIP_HIDDEN_HISTORY," + historyInfo.DISASTERUNITNAME + "," + historyInfo.UNIFIEDCODE + "," + disasterType;
        ...
        {
            //查询数据 
            TBL_LANDSLIP_HIDDEN_HISTORYEntity historyEntity = history.GetEntity(bussnessId);

            TBL_HAZARDBASICINFOEntity hazardInfo = null;

            TBL_LANDSLIP_HIDDENEntity entity = null;
            ...
            switch (updateType)
            {
                ...
                case "A":
                    //新增基本信息表
                    hazardInfo = EntityCoverter.Covert<TBL_LANDSLIP_HIDDEN_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    ...
                    //新增详情表
                    entity = EntityCoverter.Covert<TBL_LANDSLIP_HIDDEN_HISTORYEntity, TBL_LANDSLIP_HIDDENEntity>(historyEntity);
                    this.BaseRepository().Insert(entity);
                ...
                case "U":
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDSLIP_HIDDEN_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity, hazardInfo);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = historyEntity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
                ...
                case "D":                  
                    ...
                    string sql = string.Format("update TBL_LANDSLIP_HIDDEN_HISTORY set verification = '{0}' where GUID = '{1}'", historyEntity.VERIFICATION, bussnessId);
        ...
        {
            //详情表
            TBL_LANDSLIP_HIDDENEntity entity = this.BaseRepository().FindEntity(bussnessKey);
            ...
            {
                //新增历史表
                TBL_LANDSLIP_HIDDEN_HISTORYEntity historyEntity = EntityCoverter.Covert<TBL_LANDSLIP_HIDDENEntity, TBL_LANDSLIP_HIDDEN_HISTORYEntity>(entity);
                ...
                auditEntity.BUSSNESSTYPE = "A";
                auditEntity.BASICINFO = "TBL_LANDSLIP_HIDDEN_HISTORY," + historyEntity.DISASTERUNITNAME + "," + historyEntity.UNIFIEDCODE + "," + disasterType;
