...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：泥石流调查表
    /// </summary>
    public class TBL_DEBRISFLOWService : RepositoryFactory<TBL_DEBRISFLOWEntity>, TBL_DEBRISFLOWIService, IAudit
    {
        ...
        private TBL_DEBRISFLOW_HISTORYIService history = new TBL_DEBRISFLOW_HISTORYService();
        ...
        public IEnumerable<TBL_DEBRISFLOWEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TBL_DEBRISFLOWEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public TBL_DEBRISFLOWEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_DEBRISFLOWEntity entity, NEWTBL_DEBRISFLOWEntity newentity = null)
        {
             //拆分地理位置（用于基础表赋值）

            string disasterType = "泥石流";
            ...
            if (string.IsNullOrEmpty(auditor))
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_DEBRISFLOWEntity, TBL_HAZARDBASICINFOEntity>(entity, hazardInfo);
                    ...
                    //新增历史表
                    TBL_DEBRISFLOW_HISTORYEntity historyInfo = EntityCoverter.Covert<TBL_DEBRISFLOWEntity, TBL_DEBRISFLOW_HISTORYEntity>(entity);
                ...
                {
                    //新增基本信息表
                    TBL_HAZARDBASICINFOEntity hazardInfo = EntityCoverter.Covert<TBL_DEBRISFLOWEntity, TBL_HAZARDBASICINFOEntity>(entity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = entity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    auditEntity.BASICINFO = "TBL_DEBRISFLOW_HISTORY," + historyInfo.DISASTERUNITNAME + "," + historyInfo.UNIFIEDCODE + "," + disasterType;
        ...
        {
            //查询数据 
            TBL_DEBRISFLOW_HISTORYEntity historyEntity = history.GetEntity(bussnessId);

            TBL_HAZARDBASICINFOEntity hazardInfo = null;

            TBL_DEBRISFLOWEntity entity = null;
            ...
            switch (updateType)
            {
                ...
                case "A":
                    //新增基本信息表
                    hazardInfo = EntityCoverter.Covert<TBL_DEBRISFLOW_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    ...
                    //新增详情表
                    entity = EntityCoverter.Covert<TBL_DEBRISFLOW_HISTORYEntity, TBL_DEBRISFLOWEntity>(historyEntity);
                    this.BaseRepository().Insert(entity);
                ...
                case "U":
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_DEBRISFLOW_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity, hazardInfo);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = historyEntity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
                ...
                case "D":
                    ...
                    string sql = string.Format("update TBL_DEBRISFLOW_HISTORY set verification = '{0}' where GUID = '{1}'", historyEntity.VERIFICATION, bussnessId);
        ...
        {
            //详情表
            TBL_DEBRISFLOWEntity entity = this.BaseRepository().FindEntity(bussnessKey);
            ...
            {
                //新增历史表
                TBL_DEBRISFLOW_HISTORYEntity historyEntity = EntityCoverter.Covert<TBL_DEBRISFLOWEntity, TBL_DEBRISFLOW_HISTORYEntity>(entity);
                ...
                auditEntity.BUSSNESSTYPE = "A";
                auditEntity.BASICINFO = "TBL_DEBRISFLOW_HISTORY," + historyEntity.DISASTERUNITNAME + "," + historyEntity.UNIFIEDCODE + "," + disasterType;
