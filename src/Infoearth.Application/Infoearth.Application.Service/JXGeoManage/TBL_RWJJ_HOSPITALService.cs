...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：人文经济医院信息表
    /// </summary>
    public class TBL_RWJJ_HOSPITALService : RepositoryFactory<TBL_RWJJ_HOSPITALEntity>, TBL_RWJJ_HOSPITALIService
    {
        ...
        public IEnumerable<TBL_RWJJ_HOSPITALEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<TBL_RWJJ_HOSPITALEntity>();
        ...
        /// <returns></returns>
        System.Linq.Expressions.Expression<Func<TBL_RWJJ_HOSPITALEntity, bool>> queryJsonExpression(string queryJson)
        {
            var expression = LinqExtensions.True<TBL_RWJJ_HOSPITALEntity>();
            ...
            #region 根据省市县编号查询
            var expression1 = LinqExtensions.False<TBL_RWJJ_HOSPITALEntity>();
            //镇
        ...
        public IEnumerable<TBL_RWJJ_HOSPITALEntity> GetList(string queryJson)
        {
             var expression = LinqExtensions.True<TBL_RWJJ_HOSPITALEntity>();
        ...
        /// <returns></returns>
        public TBL_RWJJ_HOSPITALEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TBL_RWJJ_HOSPITALEntity entity)
        {
