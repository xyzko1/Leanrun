...
namespace Infoearth.Application.Service.JXGeoManage
{
    ...
    /// 描 述：地面沉降调查表
    /// </summary>
    public class TBL_LANDSETTLEMENTService : RepositoryFactory<TBL_LANDSETTLEMENTEntity>, TBL_LANDSETTLEMENTIService, IAudit
    {
        ...
        private TBL_LANDSETTLEMENT_HISTORYIService history = new TBL_LANDSETTLEMENT_HISTORYService();
        ...
        {
               var expression = LinqExtensions.True<TBL_LANDSETTLEMENTEntity>();
        ...
        public void SaveForm(string keyValue, TBL_LANDSETTLEMENTEntity entity, NEWTBL_LANDSETTLEMENTEntity newentity = null)
        {
            ...
            if (string.IsNullOrEmpty(auditor))
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDSETTLEMENTEntity, TBL_HAZARDBASICINFOEntity>(entity, hazardInfo);
                    ...
                    //新增历史表
                    TBL_LANDSETTLEMENT_HISTORYEntity historyInfo = EntityCoverter.Covert<TBL_LANDSETTLEMENTEntity, TBL_LANDSETTLEMENT_HISTORYEntity>(entity);
                ...
                {
                    //新增基本信息表
                    TBL_HAZARDBASICINFOEntity hazardInfo = EntityCoverter.Covert<TBL_LANDSETTLEMENTEntity, TBL_HAZARDBASICINFOEntity>(entity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = entity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    auditEntity.BASICINFO = "TBL_LANDSETTLEMENT_HISTORY," + historyInfo.DISASTERUNITNAME + "," + historyInfo.UNIFIEDCODE + "," + disasterType;
        ...
        {
            //查询数据 
            TBL_LANDSETTLEMENT_HISTORYEntity historyEntity = history.GetEntity(bussnessId);

            TBL_HAZARDBASICINFOEntity hazardInfo = null;

            TBL_LANDSETTLEMENTEntity entity = null;
            ...
            switch (updateType)
            {
                ...
                case "A":
                    //新增基本信息表
                    hazardInfo = EntityCoverter.Covert<TBL_LANDSETTLEMENT_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity);
                    hazardInfo.DISASTERTYPE = disasterType;
                    ...
                    //新增详情表
                    entity = EntityCoverter.Covert<TBL_LANDSETTLEMENT_HISTORYEntity, TBL_LANDSETTLEMENTEntity>(historyEntity);
                    this.BaseRepository().Insert(entity);
                ...
                case "U":
                    ...
                    //编辑基本信息表
                    EntityCoverter.Covert<TBL_LANDSETTLEMENT_HISTORYEntity, TBL_HAZARDBASICINFOEntity>(historyEntity, hazardInfo);
                    hazardInfo.DISASTERTYPE = disasterType;
                    hazardInfo.DISASTERNAME = historyEntity.DISASTERUNITNAME;
                    hazardInfo.PROVINCENAME = provice;
                    hazardInfo.CITYNAME = city;
                ...
                case "D":
                    ...
                    string sql = string.Format("update TBL_LANDSETTLEMENT_HISTORY set verification = '{0}' where GUID = '{1}'", historyEntity.VERIFICATION, bussnessId);
        ...
        {
            //详情表
            TBL_LANDSETTLEMENTEntity entity = this.BaseRepository().FindEntity(bussnessKey);
            ...
            {
                //新增历史表
                TBL_LANDSETTLEMENT_HISTORYEntity historyEntity = EntityCoverter.Covert<TBL_LANDSETTLEMENTEntity, TBL_LANDSETTLEMENT_HISTORYEntity>(entity);
                ...
                auditEntity.BUSSNESSTYPE = "A";
                auditEntity.BASICINFO = "TBL_LANDSETTLEMENT_HISTORY," + historyEntity.DISASTERUNITNAME + "," + historyEntity.UNIFIEDCODE + "," + disasterType;
