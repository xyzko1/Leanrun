...
namespace Infoearth.Application.IService.SystemManage
{
    ...
    public interface IDataBaseTableService
    {
        ...
        /// <param name="tableName">表明</param>
        /// <returns></returns>
        DataTable GetViewList(string dataBaseLinkId, string tableName);
        ...
        /// <param name="pagination">分页参数</param>
        /// <returns></returns>
        DataTable GetTableDataListNew(string dataBaseLinkId, string tableName, string[] switchWhere, string[] logic, string[] keyword, string[] condition, Pagination pagination);
        #endregion
