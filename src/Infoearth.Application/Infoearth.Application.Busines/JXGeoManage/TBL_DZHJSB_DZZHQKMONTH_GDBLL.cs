...
namespace Infoearth.Application.Busines.JXGeoManage
{
    ...
    /// 描 述：巡查隐患点灾情表
    /// </summary>
    public class TBL_DZHJSB_DZZHQKMONTH_GDBLL
    {
        private TBL_DZHJSB_DZZHQKMONTH_GDIService service = new TBL_DZHJSB_DZZHQKMONTH_GDService();
        ...
        {
            return service.Getdata(queryJson);
        }
        /// <summary>
        /// 获取实体
        /// </summary>
