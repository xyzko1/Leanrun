...
namespace Infoearth.Application.Mapping.JXGeoManage
{
    ...
    /// 描 述：崩塌调查表
    /// </summary>
    public class TBL_AVALANCHEMap : EntityTypeConfiguration<TBL_AVALANCHEEntity>
    {
        public TBL_AVALANCHEMap()
        {
            #region 表、主键
            //表
            this.ToTable("TBL_AVALANCHE");
            //主键
           ...
           #region 配置关系
            ...
            Property(x => x.FRACTUREGROUPNUM).HasColumnName("FRACTUREGROUPNUM").IsOptional();
