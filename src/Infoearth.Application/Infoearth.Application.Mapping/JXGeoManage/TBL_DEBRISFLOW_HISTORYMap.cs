...
namespace Infoearth.Application.Mapping.JXGeoManage
{
    ...
    /// 描 述：泥石流调查表历史表
    /// </summary>
    public class TBL_DEBRISFLOW_HISTORYMap : EntityTypeConfiguration<TBL_DEBRISFLOW_HISTORYEntity>
    {
        public TBL_DEBRISFLOW_HISTORYMap()
        {
            #region 表、主键
            //表
            this.ToTable("TBL_DEBRISFLOW_HISTORY");
            //主键
