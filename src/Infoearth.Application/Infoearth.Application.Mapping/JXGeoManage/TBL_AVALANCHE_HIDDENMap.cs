...
namespace Infoearth.Application.Mapping.JXGeoManage
{
    ...
    /// 描 述：崩塌调查表
    /// </summary>
    public class TBL_AVALANCHE_HIDDENMap : EntityTypeConfiguration<TBL_AVALANCHE_HIDDENEntity>
    {
        public TBL_AVALANCHE_HIDDENMap()
        {
            #region 表、主键
            //表
            this.ToTable("TBL_AVALANCHE_HIDDEN");
            //主键
