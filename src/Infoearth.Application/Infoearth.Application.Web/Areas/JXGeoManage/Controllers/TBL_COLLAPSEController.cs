...
namespace Infoearth.Application.Web.Areas.JXGeoManage.Controllers
{
    ...
    /// 描 述：地面塌陷调查表
    /// </summary>
    public class TBL_COLLAPSEController : MvcControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult TBL_COLLAPSEIndex()
        {
            return View();
        }
        /// <summary>
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult TBL_COLLAPSEForm()
        {
            return View();
        }
        #endregion
        ...
        {
            tbl_collapsebll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
        ...
        [HttpPost]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, TBL_COLLAPSEEntity entity)
        {
