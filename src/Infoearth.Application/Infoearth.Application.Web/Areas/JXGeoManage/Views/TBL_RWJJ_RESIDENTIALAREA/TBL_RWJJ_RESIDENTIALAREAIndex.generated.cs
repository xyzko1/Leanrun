...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/JXGeoManage/Views/TBL_RWJJ_RESIDENTIALAREA/TBL_RWJJ_RESIDENTIALAREAIndex." +
        "cshtml")]
    public partial class _Areas_JXGeoManage_Views_TBL_RWJJ_RESIDENTIALAREA_TBL_RWJJ_RESIDENTIALAREAIndex_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_JXGeoManage_Views_TBL_RWJJ_RESIDENTIALAREA_TBL_RWJJ_RESIDENTIALAREAIndex_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Areas\JXGeoManage\Views\TBL_RWJJ_RESIDENTIALAREA\TBL_RWJJ_RESIDENTIALAREAIndex.cshtml"
...
" - 542,\r\n            url: \"../../JXGeoManage/TBL_RWJJ_RESIDENTIALAREA/GetListJso" +
"n\",\r\n            datatype: \"json\",\r\n            colModel: [\r\n            ],\r\n   " +
...
");\r\n            }\r\n        });\r\n    }\r\n    //新增\r\n    function btn_add() {\r\n     " +
"   dialogOpen({\r\n            id: \'Form\',\r\n            title: \'添加人文经济居民住宅信息表\',\r\n " +
"           url: \'/JXGeoManage/TBL_RWJJ_RESIDENTIALAREA/TBL_RWJJ_RESIDENTIALAREAF" +
"orm\',\r\n            width: \'px\',\r\n            height: \'px\',\r\n            callBack" +
": function (iframeId) {\r\n                getInfoTop().frames[iframeId].AcceptCli" +
"ck();\r\n            }\r\n        });\r\n    }\r\n    //编辑\r\n    function btn_edit() {\r\n " +
"       var keyValue = $(\"#gridTable\").jqGridRowValue(\'UNIFIEDCODE\');\r\n        if" +
" (checkedRow(keyValue)) {\r\n            dialogOpen({\r\n                id: \'Form\'," +
"\r\n                title: \'编辑人文经济居民住宅信息表\',\r\n                url: \'/JXGeoManage/TB" +
"L_RWJJ_RESIDENTIALAREA/TBL_RWJJ_RESIDENTIALAREAForm?keyValue=\' + keyValue,\r\n    " +
"            width: \'px\',\r\n                height: \'px\',\r\n                callBac" +
"k: function (iframeId) {\r\n                    getInfoTop().frames[iframeId].Acce" +
"ptClick();\r\n                }\r\n            })\r\n        }\r\n    }\r\n    //删除\r\n    f" +
"unction btn_delete() {\r\n        var keyValue = $(\"#gridTable\").jqGridRowValue(\'U" +
"NIFIEDCODE\');\r\n        if (keyValue) {\r\n            $.RemoveForm({\r\n            " +
