...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/JXGeoManage/Views/TBL_ZLGC_SGINFO/TBL_ZLGC_SGINFOIndex.cshtml")]
    public partial class _Areas_JXGeoManage_Views_TBL_ZLGC_SGINFO_TBL_ZLGC_SGINFOIndex_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_JXGeoManage_Views_TBL_ZLGC_SGINFO_TBL_ZLGC_SGINFOIndex_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Areas\JXGeoManage\Views\TBL_ZLGC_SGINFO\TBL_ZLGC_SGINFOIndex.cshtml"
...
"ge/TBL_ZLGC_SGINFO/GetListJson\",\r\n            datatype: \"json\",\r\n            col" +
"Model: [\r\n            ],\r\n            onSelectRow: function () {\r\n              " +
"  selectedRowIndex = $(\'#\' + this.id).getGridParam(\'selrow\');\r\n            },\r\n " +
"           gridComplete: function () {\r\n                $(\'#\' + this.id).setSele" +
"ction(selectedRowIndex, false);\r\n            }\r\n        });\r\n    }\r\n    //新增\r\n  " +
"  function btn_add() {\r\n        dialogOpen({\r\n            id: \'Form\',\r\n         " +
"   title: \'添加治理工程-施工\',\r\n            url: \'/JXGeoManage/TBL_ZLGC_SGINFO/TBL_ZLGC_" +
"SGINFOForm\',\r\n            width: \'960px\',\r\n            height: \'640px\',\r\n       " +
...
"Form\',\r\n                title: \'编辑治理工程-施工\',\r\n                url: \'/JXGeoManage/" +
"TBL_ZLGC_SGINFO/TBL_ZLGC_SGINFOForm?keyValue=\' + keyValue,\r\n                widt" +
"h: \'px\',\r\n                height: \'px\',\r\n                callBack: function (ifr" +
"ameId) {\r\n                    getInfoTop().frames[iframeId].AcceptClick();\r\n    " +
"            }\r\n            })\r\n        }\r\n    }\r\n    //删除\r\n    function btn_dele" +
"te() {\r\n        var keyValue = $(\"#gridTable\").jqGridRowValue(\'GUID\');\r\n        " +
"if (keyValue) {\r\n            $.RemoveForm({\r\n                url: \'../../JXGeoMa" +
"nage/TBL_ZLGC_SGINFO/RemoveForm\',\r\n                param: { keyValue: keyValue }" +
",\r\n                success: function (data) {\r\n                    $(\'#gridTable" +
"\').trigger(\'reloadGrid\');\r\n                }\r\n            })\r\n        } else {\r\n" +
"            dialogMsg(\'请选择需要删除的治理工程-施工！\', 0);\r\n        }\r\n    }\r\n</script>\r\n");
