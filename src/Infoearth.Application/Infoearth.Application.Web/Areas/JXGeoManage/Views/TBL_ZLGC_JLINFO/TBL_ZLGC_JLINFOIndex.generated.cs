...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/JXGeoManage/Views/TBL_ZLGC_JLINFO/TBL_ZLGC_JLINFOIndex.cshtml")]
    public partial class _Areas_JXGeoManage_Views_TBL_ZLGC_JLINFO_TBL_ZLGC_JLINFOIndex_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_JXGeoManage_Views_TBL_ZLGC_JLINFO_TBL_ZLGC_JLINFOIndex_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Areas\JXGeoManage\Views\TBL_ZLGC_JLINFO\TBL_ZLGC_JLINFOIndex.cshtml"
...
"ge/TBL_ZLGC_JLINFO/GetListJson\",\r\n            datatype: \"json\",\r\n            col" +
"Model: [\r\n            ],\r\n            onSelectRow: function () {\r\n              " +
"  selectedRowIndex = $(\'#\' + this.id).getGridParam(\'selrow\');\r\n            },\r\n " +
"           gridComplete: function () {\r\n                $(\'#\' + this.id).setSele" +
"ction(selectedRowIndex, false);\r\n            }\r\n        });\r\n    }\r\n    //新增\r\n  " +
"  function btn_add() {\r\n        dialogOpen({\r\n            id: \'Form\',\r\n         " +
"   title: \'添加治理工程-监理\',\r\n            url: \'/JXGeoManage/TBL_ZLGC_JLINFO/TBL_ZLGC_" +
"JLINFOForm\',\r\n            width: \'px\',\r\n            height: \'px\',\r\n            c" +
...
"ZLGC_JLINFO/TBL_ZLGC_JLINFOForm?keyValue=\' + keyValue,\r\n                width: \'" +
"px\',\r\n                height: \'px\',\r\n                callBack: function (iframeI" +
"d) {\r\n                    getInfoTop().frames[iframeId].AcceptClick();\r\n        " +
"        }\r\n            })\r\n        }\r\n    }\r\n    //删除\r\n    function btn_delete()" +
" {\r\n        var keyValue = $(\"#gridTable\").jqGridRowValue(\'ZLGCID\');\r\n        if" +
" (keyValue) {\r\n            $.RemoveForm({\r\n                url: \'../../JXGeoMana" +
"ge/TBL_ZLGC_JLINFO/RemoveForm\',\r\n                param: { keyValue: keyValue },\r" +
"\n                success: function (data) {\r\n                    $(\'#gridTable\')" +
".trigger(\'reloadGrid\');\r\n                }\r\n            })\r\n        } else {\r\n  " +
"          dialogMsg(\'请选择需要删除的治理工程-监理！\', 0);\r\n        }\r\n    }\r\n</script>\r\n");
