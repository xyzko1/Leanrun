...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/JXGeoManage/Views/TBL_RWJJ_ENTERPRISE/TBL_RWJJ_ENTERPRISEIndex.cshtml")]
    public partial class _Areas_JXGeoManage_Views_TBL_RWJJ_ENTERPRISE_TBL_RWJJ_ENTERPRISEIndex_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_JXGeoManage_Views_TBL_RWJJ_ENTERPRISE_TBL_RWJJ_ENTERPRISEIndex_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Areas\JXGeoManage\Views\TBL_RWJJ_ENTERPRISE\TBL_RWJJ_ENTERPRISEIndex.cshtml"
...
"     url: \"../../Map/GetTreeJsonForMap\",\r\n            onnodeclick: function (ite" +
"m) {\r\n                AreaCode = item.id;\r\n                if(item.value.split(\'" +
",\')[1]  < 3) {\r\n                     //展开下级\r\n                     $(\".bbit-tree-" +
"selected\").children(\'.bbit-tree-ec-icon\').trigger(\"click\");\r\n                }\r\n" +
"                $(\'#btn_Search\').trigger(\"click\");\r\n            },\r\n        };\r\n" +
"        //初始化\r\n        $(\"#itemTree\").treeview(item);\r\n    };\r\n    //加载地图\r\n    v" +
"ar mapCtlExt = null;\r\n    function GetMapData() {\r\n          $.ajax({\r\n         " +
"    url: \'../../Map/GetMapDatas\',\r\n             async: false,\r\n             type" +
": \"GET\",\r\n             success: function (data) {\r\n                       var da" +
"taSet = JSON.parse(data);\r\n                        mapCtlExt= $(\"#mapControl\").m" +
"apCtl({\r\n                                mapwidth: 1500,\r\n                      " +
...
"           }\r\n        });\r\n    }\r\n    //新增\r\n    function btn_add() {\r\n        di" +
"alogOpen({\r\n            id: \'Form\',\r\n            title: \'添加人文经济企业信息表\',\r\n        " +
"    url: \'/JXGeoManage/TBL_RWJJ_ENTERPRISE/TBL_RWJJ_ENTERPRISEForm\',\r\n          " +
"  width: \'px\',\r\n            height: \'px\',\r\n            callBack: function (ifram" +
"eId) {\r\n                getInfoTop().frames[iframeId].AcceptClick();\r\n          " +
"  }\r\n        });\r\n    }\r\n    //编辑\r\n    function btn_edit() {\r\n        var keyVal" +
"ue = $(\"#gridTable\").jqGridRowValue(\'UNIFIEDCODE\');\r\n        if (checkedRow(keyV" +
"alue)) {\r\n            dialogOpen({\r\n                id: \'Form\',\r\n               " +
" title: \'编辑人文经济企业信息表\',\r\n                url: \'/JXGeoManage/TBL_RWJJ_ENTERPRISE/T" +
"BL_RWJJ_ENTERPRISEForm?keyValue=\' + keyValue,\r\n                width: \'px\',\r\n   " +
"             height: \'px\',\r\n                callBack: function (iframeId) {\r\n   " +
"                 getInfoTop().frames[iframeId].AcceptClick();\r\n                }" +
"\r\n            })\r\n        }\r\n    }\r\n    //删除\r\n    function btn_delete() {\r\n     " +
"   var keyValue = $(\"#gridTable\").jqGridRowValue(\'UNIFIEDCODE\');\r\n        if (ke" +
"yValue) {\r\n            $.RemoveForm({\r\n                url: \'../../JXGeoManage/T" +
"BL_RWJJ_ENTERPRISE/RemoveForm\',\r\n                param: { keyValue: keyValue },\r" +
"\n                success: function (data) {\r\n                    $(\'#gridTable\')" +
".trigger(\'reloadGrid\');\r\n                }\r\n            })\r\n        } else {\r\n  " +
"          dialogMsg(\'请选择需要删除的人文经济企业信息表！\', 0);\r\n        }\r\n    }\r\n      //查询表格函数\r" +
"\n      function SearchEvent() {\r\n        var queryJson = $(\"#filter-form\").getWe" +
"bControls();\r\n        queryJson[\"AreaCode\"] = AreaCode\r\n            $(\"#gridTabl" +
"e\").jqGrid(\'setGridParam\', {\r\n                 postData: { queryJson: JSON.strin" +
"gify(queryJson) },\r\n                 url: \"../../JXGeoManage/TBL_RWJJ_ENTERPRISE" +
"/GetListJson\"\r\n            }).trigger(\'reloadGrid\');\r\n        }\r\n      function " +
...
"emoveClass(\"fa-chevron-down\");\r\n             $(\"#lr-colgrid i\").addClass(\"fa-che" +
...
"d i\").addClass(\"fa-chevron-down\");\r\n        }\r\n        mapCtlExt.updateSize();\r\n" +
"      }\r\n      function ColMapDiv() {\r\n        var layout2 = $(\'#layout2\').layou" +
"t();\r\n        if ($(\"#lr-colmap i\").hasClass(\"fa-chevron-up\")) {\r\n            la" +
"yout2.sizePane(\"north\", 1);\r\n            $(\"#lr-colmap i\").removeClass(\"fa-chevr" +
"on-up\");\r\n            $(\"#lr-colmap i\").addClass(\"fa-chevron-down\");\r\n          " +
"  if ($(\"#lr-colgrid i\").hasClass(\"fa-chevron-up\")) {\r\n                $(\"#lr-co" +
"lgrid i\").removeClass(\"fa-chevron-up\");\r\n                $(\"#lr-colgrid i\").addC" +
