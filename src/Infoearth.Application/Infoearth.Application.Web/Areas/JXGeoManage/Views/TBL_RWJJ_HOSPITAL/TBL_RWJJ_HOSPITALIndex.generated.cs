...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/JXGeoManage/Views/TBL_RWJJ_HOSPITAL/TBL_RWJJ_HOSPITALIndex.cshtml")]
    public partial class _Areas_JXGeoManage_Views_TBL_RWJJ_HOSPITAL_TBL_RWJJ_HOSPITALIndex_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_JXGeoManage_Views_TBL_RWJJ_HOSPITAL_TBL_RWJJ_HOSPITALIndex_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Areas\JXGeoManage\Views\TBL_RWJJ_HOSPITAL\TBL_RWJJ_HOSPITALIndex.cshtml"
...
"         }\r\n        });\r\n    }\r\n    //新增\r\n    function btn_add() {\r\n        dial" +
"ogOpen({\r\n            id: \'Form\',\r\n            title: \'添加人文经济医院信息表\',\r\n          " +
"  url: \'/JXGeoManage/TBL_RWJJ_HOSPITAL/TBL_RWJJ_HOSPITALForm\',\r\n            widt" +
"h: \'px\',\r\n            height: \'px\',\r\n            callBack: function (iframeId) {" +
"\r\n                getInfoTop().frames[iframeId].AcceptClick();\r\n            }\r\n " +
"       });\r\n    }\r\n    //编辑\r\n    function btn_edit() {\r\n        var keyValue = $" +
"(\"#gridTable\").jqGridRowValue(\'UNIFIEDCODE\');\r\n        if (checkedRow(keyValue))" +
" {\r\n            dialogOpen({\r\n                id: \'Form\',\r\n                title" +
": \'编辑人文经济医院信息表\',\r\n                url: \'/JXGeoManage/TBL_RWJJ_HOSPITAL/TBL_RWJJ_" +
"HOSPITALForm?keyValue=\' + keyValue,\r\n                width: \'px\',\r\n             " +
"   height: \'px\',\r\n                callBack: function (iframeId) {\r\n             " +
"       getInfoTop().frames[iframeId].AcceptClick();\r\n                }\r\n        " +
"    })\r\n        }\r\n    }\r\n    //删除\r\n    function btn_delete() {\r\n        var key" +
"Value = $(\"#gridTable\").jqGridRowValue(\'UNIFIEDCODE\');\r\n        if (keyValue) {\r" +
"\n            $.RemoveForm({\r\n                url: \'../../JXGeoManage/TBL_RWJJ_HO" +
"SPITAL/RemoveForm\',\r\n                param: { keyValue: keyValue },\r\n           " +
"     success: function (data) {\r\n                    $(\'#gridTable\').trigger(\'re" +
"loadGrid\');\r\n                }\r\n            })\r\n        } else {\r\n            di" +
"alogMsg(\'请选择需要删除的人文经济医院信息表！\', 0);\r\n        }\r\n    }\r\n      //查询表格函数\r\n      funct" +
"ion SearchEvent() {\r\n        var queryJson = $(\"#filter-form\").getWebControls();" +
"\r\n        queryJson[\"AreaCode\"] = AreaCode\r\n            $(\"#gridTable\").jqGrid(\'" +
"setGridParam\', {\r\n                 postData: { queryJson: JSON.stringify(queryJs" +
"on) },\r\n                 url: \"../../JXGeoManage/TBL_RWJJ_HOSPITAL/GetListJson\"\r" +
...
"olmap i\").addClass(\"fa-chevron-up\");\r\n             }\r\n        }\r\n        else {\r" +
...
"olgrid i\").hasClass(\"fa-chevron-up\")) {\r\n                $(\"#lr-colgrid i\").remo" +
"veClass(\"fa-chevron-up\");\r\n                $(\"#lr-colgrid i\").addClass(\"fa-chevr" +
"on-down\");\r\n            }\r\n        }\r\n        else {\r\n            layout2.sizePa" +
"ne(\"north\", layout2NorthH);\r\n            $(\"#lr-colmap i\").removeClass(\"fa-chevr" +
