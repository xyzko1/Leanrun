...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/ReportManage/Views/ReportDemo/Purchase.cshtml")]
    public partial class _Areas_ReportManage_Views_ReportDemo_Purchase_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_ReportManage_Views_ReportDemo_Purchase_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
...
"owidth: true,\r\n            colModel: [\r\n                { name: \"date\", label: \"" +
"采购日期\", width: 100, align: \"center\" },\r\n                { name: \"billNo\", label: " +
"\"采购单据号\", width: 120, align: \"center\" },\r\n                { name: \"buName\", label" +
": \"供应商\", width: 200, align: \"left\" },\r\n                { name: \"invNo\", label: \"" +
"商品编号\", width: 80, align: \"left\" },\r\n                { name: \"invName\", label: \"商" +
"品名称\", width: 200, align: \"left\" },\r\n                { name: \"unit\", label: \"单位\"," +
" width: 80, align: \"center\" },\r\n                { name: \"location\", label: \"仓库\"," +
" width: 80, align: \"left\" },\r\n                { name: \"qty\", label: \"数量\", width:" +
" 80, align: \"left\" },\r\n                { name: \"unitPrice\", label: \"单价\", width: " +
"80, align: \"left\", formatter: \'number\', formatoptions: { thousandsSeparator: \"\"," +
" decimalPlaces: 2 } },\r\n                { name: \"amount\", label: \"金额\", width: 80" +
", align: \"left\", formatter: \'number\', formatoptions: { thousandsSeparator: \"\", d" +
"ecimalPlaces: 2 } },\r\n                { name: \"description\", label: \"备注\", width:" +
" 180, align: \"left\" }\r\n            ],\r\n            viewrecords: true,\r\n         " +
"   rowNum: 1000,\r\n            gridview: true,\r\n            footerrow: true,\r\n   " +
...
"ooterData(\"set\", {\r\n                    \"location\": \"合计：\",\r\n                    " +
"\"amount\": totalamount,\r\n                });\r\n                $(\'table.ui-jqgrid-" +
"ftable td\').prevUntil().css(\"border-right-color\", \"#fff\");\r\n            }\r\n     " +
"   });\r\n        //点击时间范围（今天、近7天、近一个月、近三个月）\r\n        $(\"#time_horizon a.btn-defau" +
"lt\").click(function () {\r\n            $(\"#time_horizon a.btn-default\").removeCla" +
"ss(\"active\");\r\n            $(this).addClass(\"active\");\r\n            switch ($(th" +
"is).attr(\'data-value\')) {\r\n                case \"1\"://今天\r\n                    $(" +
"\"#StartTime\").val(\"");

            
            #line 49 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
...
WriteLiteral("\");\r\n                    $(\"#EndTime\").val(\"");
            ...
            #line 50 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
                                  Write(DateTime.Now.ToString("yyyy-MM-dd"));
...
"    $(\"#StartTime\").val(\"");
            ...
            #line 53 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
...
WriteLiteral("\");\r\n                    $(\"#EndTime\").val(\"");
            ...
            #line 54 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
                                  Write(DateTime.Now.ToString("yyyy-MM-dd"));
...
"     $(\"#StartTime\").val(\"");
            ...
            #line 57 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
...
WriteLiteral("\");\r\n                    $(\"#EndTime\").val(\"");
            ...
            #line 58 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
                                  Write(DateTime.Now.ToString("yyyy-MM-dd"));
...
"     $(\"#StartTime\").val(\"");
            ...
            #line 61 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
...
WriteLiteral("\");\r\n                    $(\"#EndTime\").val(\"");
            ...
            #line 62 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
                                  Write(DateTime.Now.ToString("yyyy-MM-dd"));
...
WriteLiteral(">");
            ...
            #line 121 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
                                                          Write(DateTime.Now.AddDays(-7).ToString("yyyy-MM-dd"));
...
WriteAttribute("value", Tuple.Create(" value=\"", 6060), Tuple.Create("\"", 6100)
            
            #line 130 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
                  , Tuple.Create(Tuple.Create("", 6068), Tuple.Create<System.Object, System.Int32>(Infoearth.Util.Time.GetDate(-7)
...
WriteAttribute("value", Tuple.Create(" value=\"", 6522), Tuple.Create("\"", 6561)
            
            #line 134 "..\..\Areas\ReportManage\Views\ReportDemo\Purchase.cshtml"
                , Tuple.Create(Tuple.Create("", 6530), Tuple.Create<System.Object, System.Int32>(Infoearth.Util.Time.GetToday()
...
WriteLiteral(">采购明细表</div>\r\n            <div");

WriteLiteral(" class=\"grid-subtitle\"");

WriteLiteral(">日期: 2010-03-05 至 2016-03-28</div>\r\n            <table");
