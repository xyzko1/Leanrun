(function ($) {
    ...
    $.learunindex = {
        load: function () {
            ...
            $("#sidebar-menu").height($(window).height() - 184);
            ...
            $.each(data, function (i) {
                ...
                if (row.F_ParentId == "0") {
                    ...
                    if (row.F_UrlAddress == null || row.F_UrlAddress == "") {
                        ...
                        _html += '<a class="menuItem" data-id="' + row.F_ModuleId + '" href="' + contentPath + row.F_UrlAddress + '">'
                    ...
                    window.setTimeout(function () {
                        $.ajax({
                            ...
                            success: function (data) {
                                window.location.href = ssoPath + "/Login/SSOClear?BackURL=" + contentWebUrl + "/Home/AdminLTE";
                            }
                        });
                    }, 500);
                }
