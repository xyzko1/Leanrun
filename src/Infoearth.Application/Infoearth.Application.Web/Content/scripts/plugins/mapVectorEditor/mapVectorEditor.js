    ...
    $.fn.mapVectorEditorCtl = function (settings) {
        ...
        if (defaluts.customHtml) {
            ...
            html = '<div class="ui-layout" id="map_layout">' +
                ...
                '                           <li><div class="map_borderselect" style="overflow:hidden;"><span class="map-editor-icon-4"></span><p>点选边界</p></div></li>' +
                '                       </ul>' +
                '                   </div>' +
                '                   <div class="btn_group">' +
        ...
        function afterMapBoxSelect(layerTop, layerLeft, selectFeatures) {
            ...
            layer.open({
                ...
                yes: function (index, layero) {
                    ...
                    var fillColor = defaluts.color//layero.find(".fill-color>.color-fix").css("background-color");
                    var lineColor = defaluts.color//layero.find(".side-color>.color-fix").css("background-color");
        ...
        function accordingTypeToDraw(note) {
            if (note.hasClass("map_point")) {
                ...
                mapBoxSelect();
                return;
            } else if (note.hasClass("map_borderselect")) {
                mapBorderSelect();
                return;
        ...
        function addFeature(feat) {
            ...
            var color = 'rgba(251,127,67,1.0)';
            if (defaluts.color){
                color = defaluts.color;
            }
