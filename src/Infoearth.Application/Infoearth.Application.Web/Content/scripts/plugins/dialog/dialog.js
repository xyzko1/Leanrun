...
function (a, b) {
    ...
    f.pt.vessel = function (a, b) {
        ...
        var _length = getInfoTop().$(".layui-layer-shade").length;
    ...
    f.pt.callback = function () {
        ...
        function () {
            var e = c(this).index();
            //将2修改为3，去掉点击第二个按钮之后调用close的回调  by wc
            0 === e ? f.yes ? f.yes(b.index, d) : layer.close(b.index) : 3 === e ? a() : f["btn" + (e + 1)] ? f["btn" + (e + 1)](b.index, d) : layer.close(b.index)
        }),
