(function ($) {
    ...
    $.learuntab = {
        ...
        addTab: function () {
            ...
            var icon_classname = $(this).children("i").attr("class");
            if (dataId != "") {
            ...
            if (flag) {
                ...
                $('.menuTabs .page-tabs-content').append(str);
                $.learuntab.scrollToTab($('.menuTab.active'));
                $.learuntab.addEvent({ id: dataId, title: menuName, closed: true, icon: icon_classname, url: contentPath + dataUrl });
            }
            return false;
        },
    ...
    $.learunindex = {
        load: function () {
            $("#content-wrapper").find('.mainContent').height($(window).height() - 148);
            ...
            $.each(data, function (i) {
                ...
                if (row.F_ParentId == "0") {
                    if (row.F_UrlAddress == null || row.F_UrlAddress == "") {
                        ...
                        _html += '<li><a class="menuItem" data-id="' + row.F_ModuleId + '" href="' + row.F_UrlAddress + '"><i class="fa ' + row.F_Icon + '"></i><span>' + row.F_FullName + '</span></a><em></em></li>';
                    }
                }
            });
                    ...
                    window.setTimeout(function () {
                        $.ajax({
                            ...
                            success: function (data) {
                                window.location.href = ssoPath + "/Login/SSOClear?BackURL=" + contentWebUrl + "/Home/AdminWindos";
                            }
                        });
                    }, 500);
                }
