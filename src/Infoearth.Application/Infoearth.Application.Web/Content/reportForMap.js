                ...
                success: function (data) {
                    ...
                    if (data != null && data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            html += '<div class="col-sm-6 col-md-3 report-list" style="width:295px;"><a class="linkName" style="width: 180px !important; overflow: hidden; white-space: nowrap;text-overflow: ellipsis;float: left;" title="' + data[i].REPORTNAME + '(' + data[i].CREATETIME.replace("T", " ") + ')" href="javascript:void(0)"><span style="display:none;">' + data[i].GUID + '</span>' + data[i].REPORTNAME + '(' + data[i].CREATETIME.replace("T", " ") + ')</a><a class="link" href="javascript:void(0)" style="margin-left:5px;float: left;"><i class="fa fa-file-excel-o"></i>报表详情</a><span class="delIcon" name="' + data[i].GUID + '" style="margin-top:0;float: left;">×</span></div>';
                        }
                        _r.html(html);
