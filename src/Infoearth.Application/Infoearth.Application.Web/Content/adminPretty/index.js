    ...
    $.learuntab = {
        ...
        addTab: function () {
            ...
            if (flag) {
                ...
                $('.menuTabs .page-tabs-content').append(str);
                $.learuntab.scrollToTab($('.menuTab.active'));
                $.learuntab.addEvent({ id: dataId, title: menuName1, closed: true, icon: icon_classname, url: contentPath + dataUrl });
            }
    ...
    $.learunindex = {
        load: function () {
            ...
            $("#UserSetting").click(function () {
                //window.location = ssoPath + "/PersonCenter/Index";
            ...
            $.each(data, function (i) {
                ...
                if (row.F_ParentId == "0") {
                    ...
                    if (row.F_UrlAddress == null || row.F_UrlAddress == "") {
                        ...
                        _itemHtml += '<a class="menuiframe" data-id="' + row.F_ModuleId + '" href="' + row.F_UrlAddress + '">';
                    }
                    ...
                    window.setTimeout(function () {
                        $.ajax({
                            ...
                            success: function (data) {
                                window.location.href = ssoPath + "/Login/SSOClear?BackURL=" + contentWebUrl + "/Home/AdminPretty";
                            }
                        });
                    }, 500);
                }
