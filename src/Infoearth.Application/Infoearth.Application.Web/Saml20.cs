...
namespace Infoearth.Application.Web
{
    ...
    public class AuthRequest
    {
        ...
        public string GetRequest(AuthRequestFormat format)
        {
            ...
            test+="<saml:AuthnRequest xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:protocol\" AssertionConsumerServiceURL=\"http://172.22.20.71/manager/SAML2/SPAssertionConsumer\" Destination=\"http://172.22.20.71:9875/bspuser/SAML2/POST/SSO\" IdpEntityID=\"bspuser\" ForceAuthn=\"false\" IssueInstant=\"20170307 09:26:53\" ProtocolBinding=\"urn:oasis:nanmes:tc:SAML:2.0:bindings:HTTP-POST\" isPassive=\"false\" Version=\"2.0\"><saml:Issuer xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\">manager</saml:Issuer></saml:AuthnRequest>";
            byte[] toEncodeAsBytes = System.Text.ASCIIEncoding.ASCII.GetBytes(test);
