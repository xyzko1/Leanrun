...
namespace Infoearth.Application.Web
{
    ...
    public class HandlerErrorAttribute : HandleErrorAttribute
    {
        ...
        private void WriteLog(ExceptionContext context)
        {
            ...
            {
                logMessage.ExceptionInfo = Error.Message+Environment.NewLine+Error.StackTrace;
            }
            else
            {
                logMessage.ExceptionInfo = Error.InnerException.Message + Environment.NewLine + Error.InnerException.StackTrace; 
            }
