...
### 开发中  
*  【新增功能】增加SceneOrigin类，用于获取场景原点坐标  
*  【新增功能】增加DLGClip类，用于矢量裁剪  
*  【新增功能】BilDemFile类，支持直接使用高程数组赋值  
*  【新增功能】DLGHelp类，增加根据一个shp文件的结构生成另一个shp文件  

### 1.0.6555.32550      
*  【新增功能】Marshal类增加控制程序单一实例的方法  
*  【新增功能】PhotoEXIF类增加几个读写EXIF的方法  
*  【修改BUG】ColorSpaceHelper类解析十六进制颜色值时支持小写字母    
*  【新增功能】Polygon类增加CreateFromWKT方法  
*  【功能优化】DOM切图时支持读取G级尺寸的nodata文件 
*  【修改BUG】修复DOMTile使用公共图片不能输出png的问题   

### 1.0.6449.37223
*  【修改BUG】修改DEM切图算法在四周是无效数据时切图失败的问题   
*  【新增功能】Img空间增加PhotoEXIF类获取照片的EXIF数据 
*  【功能优化】ImgCut方法增强错误报告，并自动生成输出文件的目录 
